...
public class QuoteRemoteCallService {
	...
	//TODO-4 Comment the below discovery client declaration  and declare LoadBalancerClient . AutoWire it.
...
/*	@Autowired
	...
	public List<Quote> getQuotes(String symbols) {
		...
		// TODO -5  Initialize the below uri using the ServiceInstance obtained from LoadBalancerClient
		/*List<ServiceInstance> instances=  discoveryClient.getInstances(quotesService);
		URI uri=instances.get(0).getUri();*/
		
		/*ServiceInstance instances = lbc.choose(quotesService);
		URI uri=instances.getUri();
		System.out.println(uri);*/
		
		/*System.out.println("getQuotes() .URI========="+uri);
