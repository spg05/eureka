...
public class PortfolioService {
	...
	// TODO -1 Inject pivotal.accountsService.name on to the below accountsService variable using @Value
	...
	public Order addOrder(Order order) {
		...
		// TODO -3 Use Discovery Client to get accountService Instances.
		// Once you get list of instances, get the URI of 1st instance and initialize the above variable
		...
		if (order.getOrderType() == OrderType.BUY) {
			...
			// TODO -4 Observe How we are using the above URI obtained from discovery client to make a restful call
